...
import com.aronim.cloud.gateway.integration.menu.MenuItem;
...
public class IndexController
{
    ...
    public String admin(HttpServletRequest request, Model model)
    {
        ...
        List<MenuItem> menuItems = menuIntegrationService.findMenuItems("main");
    ...
    private MenuItem getSelectedItem(String path, List<MenuItem> menuItems)
    {
        for (MenuItem menuItem : menuItems)
        {
            if (menuItem.getPath().equals(path))
            {
                return menuItem;
            }
        }
